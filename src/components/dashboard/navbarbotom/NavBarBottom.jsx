...
import image from  '../../assets/aea88233-522b-48b3-a9ed-3de876c9f5dd.png'
import {
    FaChartSimple,
  } from "react-icons/fa6";
  import { GiTeacher } from 'react-icons/gi';
import { getTotalGroupeSalleFormateurEmplois } from "../../authservice/create_emplois_request/createEmploisRequest";
import './indexBotom.css'
...
export default function NavBarBottom() {
  ...
  const { data, isLoading } = useQuery(['get-total-groupe-emplois'], async () => {
    try {
      const response = await getTotalGroupeSalleFormateurEmplois();
        ...
        <div className='lienDIv'>
          <div className="premier">
            ...
            <span className='premeirLogo2'>
              <div className='filieres'>Groupe</div>
              <div className='filieresNombre'>{data?.groupes}</div>
            </span>
          </div>
          <hr className="hrMenuDatsh" />
          <div className='deuxieme'>
            <p className="spanIcons">
              <FaChartSimple className="formateurIcons1" />
              <span> Toutes les filières du centre</span>
            </p>
          </div>
        </div>
      </>
      ...
      <div className='lienDIv'>
        <div className="premier">
          ...
          <span className='premeirLogo2'>
            ...
            <div className='filieresNombre'>{data?.salles}</div>
          </span>
        </div>
        <hr className="hrMenuDatsh" />
        <div className='deuxieme'>
          <p className="spanIcons">
            <FaChartSimple className="formateurIcons2" />
            <span>Toutes les salles du centre</span>
          </p>
        </div>
      </div>
    )}
  ...
  {/* Les formateurs */}
  <Link to='/formateur/liste-formateur'>
    {isLoading ? (
      <Skeleton className="skeletom" baseColor="#f8f8f8" highlightColor="#ffffff" />
    ) : (
      <div className='lienDIv'>
        <div className="premier">
          ...
          <span className='premeirLogo2'>
            ...
            <div className='filieresNombre'>{data?.formateurs}</div>
          </span>
        </div>
        <hr className="hrMenuDatsh" />
        <div className='deuxieme'>
          <p className="spanIcons">
            <FaChartSimple className="formateurIcons3" />
            <span> Tous les formateurs du centre</span>
          </p>
        </div>
      </div>
    )}
